    ...
    <body>
      <div>
        ...
        <div className="blocks">
          ...
          <div>
            <p2>
              <strong>Challenge:</strong> Build a customer service app for a
          ...
          <div className="research-block" style={{ marginTop: "50px" }}>
            ...
            <p4>
              ...
              group of users would be young adults who frequent the food truck
              for a quick and delicious bite to eat. Research revealed that
              there are issues that arise when attempting to dine at food
              trucks. Some issues include: figuring out the location of the food
              truck, long lines, and getting wrong orders
            </p4>
            <br></br>
            ...
            <p4>
              ...
              without having to wait in a long line. He wants to try as many
              food trucks as possible to get the most out of his trip
            </p4>
            <br></br>
            <div style={{ marginTop: "30px" }}>
              <p4>
                A <strong>Journey Map </strong> was created to help map out the
                tasks that a user may encounter while using the app. I was able
                to find areas were a user could potentially become nervous or
                unsure. These user feelings lead to improvement opportunities
                such as rewards for first time users that could be beneficial
              </p4>
              <br></br>
        ...
        <div className="blocks">
          <p6>
            {" "}
            After conducting two rounds of usability studies I found a few
            things to be true.
          </p6>
          <br></br>
          <img
          ...
          <p6>
            ...
            the differnt icons which left some uers confused. After the
            usability study I added many labels so it is clear what each icon
            action is
          </p6>
          <br></br>
          <img
        ...
        <div className="blocks">
          ...
          <br></br>
          <p6>
            <strong>Impact:</strong> empireats allows the user to feel taken
            care of in their quest to satisfy their hunger and cravings{" "}
          </p6>
          <br></br>
          <p6>
